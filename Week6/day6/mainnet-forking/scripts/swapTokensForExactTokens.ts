...
const main = async ()=>{
    ...
    console.log("=======Before============");
    console.log("USDC Balance Before: ", Number(usdcBalBefore));
    console.log("DAI Balance Before: ", Number(daiBalBefore));

    const trans = await ROUTER.swapTokensForExactTokens(amountOut,amountInMax,path, impersonatedSigner.address,deadline);
    ...
    console.log("DAI Spent: ", ethers.formatUnits(daiBalAfter - daiBalBefore ));
    console.log("USDC Spent: " , ethers.formatUnits(usdcBalBefore - usdcBalAfter))
